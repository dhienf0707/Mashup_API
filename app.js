...
const allowLocalhostOnly = (req, res, next) => {
    ...
    const isLocal = referer ? referer.startsWith('http://localhost') || referer.startsWith('https://mashup-api.onrender.com/') || referer.startsWith('https://mashup-api-webapp.azurewebsites.net') : false
    if (isLocal) {
